...
// Ambil set JADWAL yang sudah dipilih 
$mk_sudah_dipilih = [];        
$jadwal_sudah_diambil = [];      
if ($id_semester){
...
<body>
  <div class="konten_utama">
    ...
    <?php if(!$id_semester): ?>
    <div class="kotak_info info_peringatan">Belum ada <b>Semester</b> berstatus <b>Aktif</b>. Pemilihan jadwal
      dinonaktifkan.</div>
    <?php elseif(!$kontrak): ?>
    ...
    <div class="kotak_info info_gagal">Status kontrak pada Semester Aktif: <b>Ditolak</b>. Silakan perbaiki pengajuan
      kontrak.</div>
    <?php elseif($status_bayar === 'Menunggu'): ?>
    <div class="kotak_info info_peringatan">Status kontrak pada Semester Aktif: <b>Menunggu</b>. Pemilihan jadwal akan
      aktif setelah <b>Disetujui</b>.</div>
    <?php else: ?>
    <div class="kotak_info info_sukses">Status kontrak pada Semester Aktif: <b>Disetujui</b>. Silakan memilih shift.
    </div>
    <?php endif; ?>
