...
if ($id_dosen <= 0) { header("Location: ../login.php"); exit; }
...
$q = mysqli_prepare($conn,"
  SELECT d.nidn, d.nama, u.id AS id_user
  FROM dosen d
  LEFT JOIN users u ON u.id = d.user_id
  WHERE d.id = ?
  LIMIT 1
");
mysqli_stmt_bind_param($q, "i", $id_dosen);
...
<head>
  ...
  <title>Pengaturan Akun Dosen</title>
...
<body>
  <div class="bungkus">
    ...
    <div class="pembungkus">
      <div class="kartu">
        <h3><i class="fa-solid fa-shield-halved"></i> Keamanan Akun Dosen</h3>
        <form method="post" autocomplete="off">
          ...
          <div style="margin-top:10px">
            <button class="tombol-utama" type="submit"><i class="fa-solid fa-key"></i> Ganti Password</button>
          </div>
        </form>
      </div>
    </div>
