...
.tabel-ruangan { width:100%; border-collapse:collapse; background:white; border-radius:10px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1); table-layout:fixed; }
.tabel-ruangan th { background:#00AEEF; color:#333; text-align:left; padding:12px 15px; }
.tabel-ruangan td { padding:12px 15px; border-bottom:1px solid #ddd; border-right:1px solid #ddd; }
.tabel-ruangan tr:hover { background:#f1f1f1; }
...
.isi-modal input { width:100%; padding:10px; margin:5px 0; border:1px solid #ccc; border-radius:6px; }
...
@media screen and (max-width: 768px) {
  ...
  .tabel-ruangan, thead, tbody, th, td, tr { display:block; }
